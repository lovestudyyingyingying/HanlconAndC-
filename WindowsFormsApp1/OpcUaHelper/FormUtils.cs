            ...
            try
            {
                ...
                while (nodesToBrowse.Count > 0)
                {
                    ...
                    while (continuationPoints.Count > 0)
                    {
                        ...
                        continuationPoints = revisedContiuationPoints;//https://github.com/dathlin/OpcUaHelper/issues/38  这里表示需要修改 原始代码会陷入死循环 revisedContiuationPoints = continuationPoints;
                    }
